  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-slate-100 flex flex-col justify-between select-none relative overflow-hidden font-sans">
      ...
      <main className="max-w-5xl w-full mx-auto p-4 sm:p-6 z-20 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-auto">
        {/* Left Col: Studio Overview & 1-Click Members (Only in Demo Mode) */}
        {process.env.NEXT_PUBLIC_DEMO_MODE === 'true' ? (
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0d121c] border border-[#1d273a] text-slate-400 text-xs font-medium">
                ...
                <span>Socialeyes Studio Production Suite (Demo Sandbox)</span>
              </div>
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0d121c] border border-[#1d273a] text-slate-400 text-xs font-medium">
              ...
              <span>Multi-Tenant Production Authentication</span>
            </div>
            <h1 className="text-2xl sm:text-4xl font-serif font-normal text-white leading-tight">
              Broadcast-Grade Video Review & Project Management
            </h1>
            <p className="text-sm text-slate-400 leading-relaxed">
              Sign in with your enterprise credentials to access your tenant workspaces, review sessions, and collaborative timelines.
            </p>
          </div>
        )}

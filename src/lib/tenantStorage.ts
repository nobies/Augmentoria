...
const RAW_CLIENT_DEFINITIONS: ClientDefinition[] = [
  ...
  },
  {
    ...
    projectThemes: [
      { title: 'Air Max 2026 — Velocity Launch', desc: 'Global flagship product reveal featuring dynamic VFX transitions and sound design.', fps: 24, colorSpace: 'Rec.709', thumbnail: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&auto=format&fit=crop&q=80', videoUrl: 'https://www.youtube.com/watch?v=ScMzIvxBSi4' },
  ...
  },
  {
    ...
    projectThemes: [
      { title: 'Spotify Wrapped 2026 — Creator Spotlight', desc: 'Mini-documentary series celebrating breakthrough international artists.', fps: 25, colorSpace: 'Rec.709', thumbnail: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800&auto=format&fit=crop&q=80', videoUrl: 'https://www.youtube.com/watch?v=ScMzIvxBSi4' },
  ...
  },
  {
    ...
    projectThemes: [
      ...
      { title: 'PlayStation VR2 — Enter the Horizon', desc: 'Gaze tracking and OLED HDR headset demo following robotic mechanical dinosaurs.', fps: 60, colorSpace: 'ACEScg', thumbnail: 'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?w=800&auto=format&fit=crop&q=80', videoUrl: 'https://www.youtube.com/watch?v=ScMzIvxBSi4' },
